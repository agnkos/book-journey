...
const Menu = ({ toggle, closeMenu }) => {
    ...
    return (
        ...
        `}>
            ...
            <li onClick={closeMenu}><NavLink to='addbook2' className={({ isActive }) => `${isActive ? 'text-link-active' : 'text-light-bg'} py-1 block hover:text-link-active transition duration-150`}>Add a book 2</NavLink></li>
