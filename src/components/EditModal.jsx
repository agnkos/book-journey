    ...
    return (
        <div onClick={handleOuterClick} className='fixed top-0 left-0 py-8 flex justify-center items-center w-full h-full bg-text-faded/50 z-30'>
            <div ref={modalRef} className="w-11/12 max-w-md max-h-full flex flex-col bg-light-bg rounded-md z-50 overflow-y-auto">
                <div className="flex p-6 bg-main-accent text-light-bg">
                    <div>
                    ...
                    <XMarkIcon className="w-6 h-6 ml-auto cursor-pointer stroke-light-bg hover:stroke-danger hover:ring-offset-2 hover:ring-offset-main-accent hover:ring-2 hover:ring-danger rounded-full transition duration-150"
                        onClick={closeModal}
                    />
                </div>
                <div className="p-6">
